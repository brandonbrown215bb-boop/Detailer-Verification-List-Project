  ...
  return (
    ...
    >
      <form onSubmit={handleSave} className="space-y-4">
        ...
        <div>
          <label htmlFor="com-number-input" className="block text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-1.5">
            COM Number (MAPICS):
          </label>
          <input
            id="com-number-input"
            aria-label="COM Number (MAPICS)"
            type="text"
            autoFocus
            value={com}
