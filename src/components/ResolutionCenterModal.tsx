          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-white flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-300 font-mono text-xs font-semibold">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          {pendingFacts.length === 0 ? (
            <div className="py-12 text-center space-y-3">
              ...
              <h4 className="text-sm font-bold text-white">All Facts Confirmed!</h4>
            ...
            <>
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-gradient-to-r from-blue-900/30 to-indigo-900/20 border border-blue-800/40">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between">
                        ...
                        {fact.value !== null && (
                          <span className="text-xs font-mono font-bold text-slate-200 px-2 py-1 rounded bg-slate-800 border border-slate-700">
